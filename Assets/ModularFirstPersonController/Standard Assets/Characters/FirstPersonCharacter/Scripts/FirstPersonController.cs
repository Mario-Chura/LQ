...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private int yminim = -10;
        ...
        private void Update()
        {
            if (!PlayerSingleton.isGameOver) //no es game over
            {
                RotateView();
        ...
        private void YMinim()
        {
            //si baja mucho en el eje Y muere el personaje
            if (gameObject.transform.position.y < yminim)
